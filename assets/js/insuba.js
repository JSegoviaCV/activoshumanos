(function ($) {
 ...
 if ($(".insuba-accordion").length) {
  ...
  accordionGrp.each(function () {
    ...
    // 1. Ocultamos todo el contenido primero
    Self.find(".accordion .accordion-content").hide();
    
    // 2. IMPORTANTE: Buscamos la que tenga la clase "active" (la primera) y la mostramos
    ...
    accordion.each(function () {
      $(this).find(".accordion-title").on("click", function () {
        ...
        var isOpen = currentAccordion.hasClass("active");

        // Lógica para cerrar las demás al hacer clic
        ...
        if (!isOpen) {
          ...
          currentAccordion.find(".accordion-content").slideDown();
        }
      });
    });
  });
